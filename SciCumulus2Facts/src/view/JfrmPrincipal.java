...
public class JfrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtxtDatabase2 = new javax.swing.JTextField();
        ...
        jLabel1.setText("SciCumulus Cartridge");

        jtxtUsername.setText("postgres");

        jpwPass.setText("123456");

        jtxtDatabase.setText("SciCumulus-PatientDiag");
        ...
        jLabel6.setText("Database 2");

        jtxtDatabase2.setText("patientdiag");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jtxtDatabase2, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(161, 161, 161)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jtxtDatabase2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jtxtDataSetName.setText("SciCumulus");

        jLabel9.setText("Dataset Id");

        jtxtDataSetId.setText("1");
    ...
    public void generateFacts()throws ClassNotFoundException, SQLException { 
        ...
        String database2 = jtxtDatabase2.getText();
        ...
        new control.prospective.Workflow(output);       
        new control.prospective.Program(output); 
        new control.prospective.Port(output);          
              
        //Prospective relationships
        new control.prospective.relationship.HasSubProgram(output);
        new HasOutPort(output);
        new HasInPort(output);

        //Prospective and Retrospective entities
        new control.retrospective.Data(output, database2);
        //new Document(output);

        //Retrospective Entities
        new control.retrospective.WExecution(output);          
        new control.retrospective.Execution(output);
        
        //Retrospective relationships
        new control.retrospective.relationship.WasGeneratedBy(output, database2);
        new control.retrospective.relationship.Used(output, database2);                 
        new control.retrospective.relationship.WasPartOf(output); 
        new control.retrospective.relationship.WasAssociatedWith(output);
        new control.retrospective.relationship.WasInformedBy(output);
        new WasDerivedFrom(output);
        new control.retrospective.relationship.HadPlan(output);
        new HadInPort(output);
        new HadOutPort(output);                        
        new control.retrospective.User(output);
    ...
    private javax.swing.JTextField jtxtDatabase2;
