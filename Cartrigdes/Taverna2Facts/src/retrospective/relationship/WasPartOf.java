...
public class WasPartOf {
    String dataId, executionId, wexecutionId;
    
    public WasPartOf(StringBuffer output, RDFManager rdf){        
        Statement stmt;
        Property  predicate; 
        RDFNode   object;          
        ...
        for(Resource subject : resourceList){
            ...
            while(iter.hasNext()){
                ...
                if(predicate.getLocalName().equals("wasPartOfWorkflowRun")){
                    executionId = "'" + subject.toString() + "'";
                    wexecutionId = "'" + object.toString() + "'";                      
                    generateFact(output);
                }                                            
              }             
        } 
