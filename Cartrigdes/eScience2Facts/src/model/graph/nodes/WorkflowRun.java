...
public class WorkflowRun extends Process {
    ...
    public static final String WORKFLOW_ENGINE_IP = "workflowEngineIP";
    ...
    public String getWorkflowEngineIp() { return (String) underlyingNode.getProperty(WORKFLOW_ENGINE_IP);}

    public void setWorkflowEngineIp(String workflowEngineIp) { underlyingNode.setProperty(WORKFLOW_ENGINE_IP, workflowEngineIp);}
